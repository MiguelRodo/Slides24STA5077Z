...
knitr::include_graphics(
  projr::projr_path_get("raw-data-img", "airline_distance.png")
)
```
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{_raw_data/img/airline_mds.png}
\end{figure}
...
#| fig-align: center
knitr::include_graphics(
  projr::projr_path_get("raw-data-img", "city_distance.png")
)
```
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{_raw_data/img/morse_code_dots.png}
\end{figure}
...
\begin{figure}[H]
\center
\includegraphics[width=0.5\textwidth]{_raw_data/img/morse_code_mds.png}
\end{figure}
